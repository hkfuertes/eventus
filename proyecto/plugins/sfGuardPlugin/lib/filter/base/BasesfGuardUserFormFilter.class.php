...
abstract class BasesfGuardUserFormFilter extends BaseFormFilterPropel
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'participation_list'            => new sfWidgetFormPropelChoice(array('model' => 'Event', 'add_empty' => true)),
    ));
    ...
    $this->setValidators(array(
      ...
      'participation_list'            => new sfValidatorPropelChoice(array('model' => 'Event', 'required' => false)),
    ));
  ...
  public function addParticipationListColumnCriteria(Criteria $criteria, $field, $values)
  {
    ...
    $criteria->addJoin(ParticipationPeer::USER_ID, sfGuardUserPeer::ID);

    $value = array_pop($values);
    $criterion = $criteria->getNewCriterion(ParticipationPeer::EVENT_ID, $value);

    foreach ($values as $value)
    {
      $criterion->addOr($criteria->getNewCriterion(ParticipationPeer::EVENT_ID, $value));
    }
