...
/**
 * Base static class for performing query and update operations on the 'programs' table.
 *
 * 
 *
...
abstract class BaseEntryPeer {
	...
	const EVENT_ID = 'programs.EVENT_ID';

	/** the column name for the HORA field */
	const HORA = 'programs.HORA';

	/** the column name for the ACTO field */
	const ACTO = 'programs.ACTO';
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'EventId', 'Hora', 'Acto', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'eventId', 'hora', 'acto', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::EVENT_ID, self::HORA, self::ACTO, ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'event_id', 'hora', 'acto', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'EventId' => 1, 'Hora' => 2, 'Acto' => 3, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'eventId' => 1, 'hora' => 2, 'acto' => 3, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::EVENT_ID => 1, self::HORA => 2, self::ACTO => 3, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'event_id' => 1, 'hora' => 2, 'acto' => 3, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, )
	);
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(EntryPeer::EVENT_ID);
		$criteria->addSelectColumn(EntryPeer::HORA);
		$criteria->addSelectColumn(EntryPeer::ACTO);
	}
	...
	/**
	 * Method to invalidate the instance pool of all tables related to programs
	...
	public static function doCountJoinEvent(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		$criteria->addJoin(EntryPeer::EVENT_ID, EventPeer::ID, $join_behavior);
	...
	/**
	 * Selects a collection of Entry objects pre-filled with their Event objects.
	 * @param      Criteria  $criteria
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	...
	public static function doSelectJoinEvent(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (Entry) to $obj2 (Event)
				$obj2->addEntry($obj1);
	...
	public static function doSelectJoinAll(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (Entry) to the collection in $obj2 (Event)
				$obj2->addEntry($obj1);
	...
	/**
	 * Method to DELETE all rows from the programs table.
	 *
	 * @return     int The number of affected rows (if supported by underlying database driver).
	 */
