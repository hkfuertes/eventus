...
abstract class BasesfGuardUserProfilePeer {
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('UserId', 'Nombre', 'Apellidos', 'Email', 'Id', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('userId', 'nombre', 'apellidos', 'email', 'id', ),
		BasePeer::TYPE_COLNAME => array (self::USER_ID, self::NOMBRE, self::APELLIDOS, self::EMAIL, self::ID, ),
		BasePeer::TYPE_FIELDNAME => array ('user_id', 'nombre', 'apellidos', 'email', 'id', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('UserId' => 0, 'Nombre' => 1, 'Apellidos' => 2, 'Email' => 3, 'Id' => 4, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('userId' => 0, 'nombre' => 1, 'apellidos' => 2, 'email' => 3, 'id' => 4, ),
		BasePeer::TYPE_COLNAME => array (self::USER_ID => 0, self::NOMBRE => 1, self::APELLIDOS => 2, self::EMAIL => 3, self::ID => 4, ),
		BasePeer::TYPE_FIELDNAME => array ('user_id' => 0, 'nombre' => 1, 'apellidos' => 2, 'email' => 3, 'id' => 4, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, )
	);
