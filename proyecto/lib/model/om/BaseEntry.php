...
/**
 * Base class that represents a row from the 'programs' table.
 *
 * 
 *
...
abstract class BaseEntry extends BaseObject  implements Persistent {
	...
	public function setEventId($v)
	{
		...
		if ($this->event_id !== $v) {
			$this->event_id = $v;
			$this->modifiedColumns[] = EntryPeer::EVENT_ID;
		}
	...
	public function setHora($v)
	{
		...
		if ( $this->hora !== null || $dt !== null ) {
					...
					)
			{
				...
				$this->modifiedColumns[] = EntryPeer::HORA;
			}
	...
	public function setActo($v)
	{
		...
		if ($this->acto !== $v) {
			$this->acto = $v;
			$this->modifiedColumns[] = EntryPeer::ACTO;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->acto = ($row[$startcol + 3] !== null) ? (string) $row[$startcol + 3] : null;
			$this->resetModified();
			...
			return $startcol + 4; // 4 = EntryPeer::NUM_COLUMNS - EntryPeer::NUM_LAZY_LOAD_COLUMNS).
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[3], $arr)) $this->setActo($arr[$keys[3]]);
	}
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(EntryPeer::EVENT_ID)) $criteria->add(EntryPeer::EVENT_ID, $this->event_id);
		if ($this->isColumnModified(EntryPeer::HORA)) $criteria->add(EntryPeer::HORA, $this->hora);
		if ($this->isColumnModified(EntryPeer::ACTO)) $criteria->add(EntryPeer::ACTO, $this->acto);
