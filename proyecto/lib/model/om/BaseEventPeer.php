...
abstract class BaseEventPeer {
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'Name', 'Key', 'Date', 'CreatedAt', 'AdminId', 'Active', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'name', 'key', 'date', 'createdAt', 'adminId', 'active', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::NAME, self::KEY, self::DATE, self::CREATED_AT, self::ADMIN_ID, self::ACTIVE, ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'name', 'key', 'date', 'created_at', 'admin_id', 'active', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'Name' => 1, 'Key' => 2, 'Date' => 3, 'CreatedAt' => 4, 'AdminId' => 5, 'Active' => 6, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'name' => 1, 'key' => 2, 'date' => 3, 'createdAt' => 4, 'adminId' => 5, 'active' => 6, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::NAME => 1, self::KEY => 2, self::DATE => 3, self::CREATED_AT => 4, self::ADMIN_ID => 5, self::ACTIVE => 6, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'name' => 1, 'key' => 2, 'date' => 3, 'created_at' => 4, 'admin_id' => 5, 'active' => 6, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, 6, )
	);
