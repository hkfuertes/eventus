...
abstract class BaseToken extends BaseObject  implements Persistent {
	...
	public function setActive($v)
	{
		...
		if ($this->active !== $v || $this->isNew()) {
			$this->active = $v;
			$this->modifiedColumns[] = TokenPeer::ACTIVE;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 5; // 5 = TokenPeer::NUM_COLUMNS - TokenPeer::NUM_LAZY_LOAD_COLUMNS).
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(TokenPeer::ACTIVE)) $criteria->add(TokenPeer::ACTIVE, $this->active);
