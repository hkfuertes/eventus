...
abstract class BaseParticipation extends BaseObject  implements Persistent {
	...
	/**
	 * Initializes internal state of BaseParticipation object.
	 * @see        applyDefaults()
	 */
	...
	public function setActive($v)
	{
		...
		if ($this->active !== $v || $this->isNew()) {
			$this->active = $v;
			$this->modifiedColumns[] = ParticipationPeer::ACTIVE;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 4; // 4 = ParticipationPeer::NUM_COLUMNS - ParticipationPeer::NUM_LAZY_LOAD_COLUMNS).
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(ParticipationPeer::ACTIVE)) $criteria->add(ParticipationPeer::ACTIVE, $this->active);
