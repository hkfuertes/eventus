...
abstract class BaseEvent extends BaseObject  implements Persistent {
	...
	public function setAdminId($v)
	{
		...
		if ($this->admin_id !== $v) {
			$this->admin_id = $v;
			$this->modifiedColumns[] = EventPeer::ADMIN_ID;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->event_type_id = ($row[$startcol + 5] !== null) ? (int) $row[$startcol + 5] : null;
			...
			return $startcol + 9; // 9 = EventPeer::NUM_COLUMNS - EventPeer::NUM_LAZY_LOAD_COLUMNS).
	...
	public function ensureConsistency()
	{
		...
		if ($this->asfGuardUser !== null && $this->admin_id !== $this->asfGuardUser->getId()) {
			$this->asfGuardUser = null;
		}
	} // ensureConsistency
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[5], $arr)) $this->setEventTypeId($arr[$keys[5]]);
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(EventPeer::ADMIN_ID)) $criteria->add(EventPeer::ADMIN_ID, $this->admin_id);
	...
	public function getEventType(PropelPDO $con = null)
	{
		if ($this->aEventType === null && ($this->event_type_id !== null)) {
			$this->aEventType = EventTypePeer::retrieveByPk($this->event_type_id);
	...
	{
		if ($this->asfGuardUser === null && ($this->admin_id !== null)) {
			$this->asfGuardUser = sfGuardUserPeer::retrieveByPk($this->admin_id);
			/* The following can be used additionally to
			   guarantee the related object contains a reference
			   to this object.  This level of coupling may, however, be
			   undesirable since it could result in an only partially populated collection
			   in the referenced object.
			   $this->asfGuardUser->addEvents($this);
			 */
		}
	 ...
	 * related Entrys from storage. If this Event is new, it will return
		...
		if ($this->collEntrys === null) {
			if ($this->isNew()) {
			   $this->collEntrys = array();
				...
				$criteria->add(EntryPeer::EVENT_ID, $this->id);
	 ...
	 * If this collection has already been initialized with an identical Criteria, it returns the collection.
	 * Otherwise if this Event has previously been saved, it will retrieve
	 * related Participations from storage. If this Event is new, it will return
	 * an empty collection or the current collection, the criteria is ignored on a new object.
	 *
	 * @param      PropelPDO $con
	 * @param      Criteria $criteria
		...
		if ($this->collParticipations === null) {
			if ($this->isNew()) {
			   $this->collParticipations = array();
				...
				$criteria->add(ParticipationPeer::EVENT_ID, $this->id);
	 ...
	 */
	public function getParticipationsJoinsfGuardUser($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		if ($criteria === null) {
			$criteria = new Criteria(EventPeer::DATABASE_NAME);
		}
		...
		if ($this->collParticipations === null) {
			if ($this->isNew()) {
				...
				$this->collParticipations = ParticipationPeer::doSelectJoinsfGuardUser($criteria, $con, $join_behavior);
			}
		} else {
			// the following code is to determine if a new query is
			// called for.  If the criteria is the same as the last
	 ...
	 * If this collection has already been initialized with an identical Criteria, it returns the collection.
	 * Otherwise if this Event has previously been saved, it will retrieve
	 * related Photos from storage. If this Event is new, it will return
	 * an empty collection or the current collection, the criteria is ignored on a new object.
	 *
	 * @param      PropelPDO $con
	 * @param      Criteria $criteria
		...
		if ($this->collPhotos === null) {
			if ($this->isNew()) {
			   $this->collPhotos = array();
				...
				$criteria->add(PhotoPeer::EVENT_ID, $this->id);
	 ...
	 * actually need in Event.
	 */
	public function getPhotosJoinsfGuardUser($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		if ($criteria === null) {
			$criteria = new Criteria(EventPeer::DATABASE_NAME);
		}
		...
		if ($this->collPhotos === null) {
			if ($this->isNew()) {
				...
				$this->collPhotos = PhotoPeer::doSelectJoinsfGuardUser($criteria, $con, $join_behavior);
			}
		} else {
			// the following code is to determine if a new query is
			// called for.  If the criteria is the same as the last
