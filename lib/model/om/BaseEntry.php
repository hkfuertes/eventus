...
abstract class BaseEntry extends BaseObject  implements Persistent {
	...
	public function setTime($v)
	{
		...
		if ( $this->time !== null || $dt !== null ) {
					...
					)
			{
				...
				$this->modifiedColumns[] = EntryPeer::TIME;
			}
	...
	public function setAct($v)
	{
		...
		if ($this->act !== $v) {
			$this->act = $v;
			$this->modifiedColumns[] = EntryPeer::ACT;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->act = ($row[$startcol + 3] !== null) ? (string) $row[$startcol + 3] : null;
			$this->resetModified();
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[3], $arr)) $this->setAct($arr[$keys[3]]);
	}
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(EntryPeer::TIME)) $criteria->add(EntryPeer::TIME, $this->time);
		if ($this->isColumnModified(EntryPeer::ACT)) $criteria->add(EntryPeer::ACT, $this->act);
