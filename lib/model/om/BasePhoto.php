...
abstract class BasePhoto extends BaseObject  implements Persistent {
	...
	public function setEventId($v)
	{
		...
		if ($this->event_id !== $v) {
			$this->event_id = $v;
			$this->modifiedColumns[] = PhotoPeer::EVENT_ID;
		}
	...
	public function setUploadedAt($v)
	{
		...
		if ( $this->uploaded_at !== null || $dt !== null ) {
					...
					)
			{
				...
				$this->modifiedColumns[] = PhotoPeer::UPLOADED_AT;
			}
	...
	public function setVisible($v)
	{
		...
		if ($this->visible !== $v || $this->isNew()) {
			$this->visible = $v;
			$this->modifiedColumns[] = PhotoPeer::VISIBLE;
		}
	...
	public function setDeleted($v)
	{
		...
		if ($this->deleted !== $v || $this->isNew()) {
			$this->deleted = $v;
			$this->modifiedColumns[] = PhotoPeer::DELETED;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->uploaded_at = ($row[$startcol + 3] !== null) ? (string) $row[$startcol + 3] : null;
			...
			$this->visible = ($row[$startcol + 7] !== null) ? (boolean) $row[$startcol + 7] : null;
			...
			return $startcol + 9; // 9 = PhotoPeer::NUM_COLUMNS - PhotoPeer::NUM_LAZY_LOAD_COLUMNS).
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[3], $arr)) $this->setUploadedAt($arr[$keys[3]]);
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(PhotoPeer::EVENT_ID)) $criteria->add(PhotoPeer::EVENT_ID, $this->event_id);
		if ($this->isColumnModified(PhotoPeer::UPLOADED_AT)) $criteria->add(PhotoPeer::UPLOADED_AT, $this->uploaded_at);
		...
		if ($this->isColumnModified(PhotoPeer::VISIBLE)) $criteria->add(PhotoPeer::VISIBLE, $this->visible);
		if ($this->isColumnModified(PhotoPeer::DELETED)) $criteria->add(PhotoPeer::DELETED, $this->deleted);
