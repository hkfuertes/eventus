...
abstract class BasesfGuardUserProfilePeer {
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('UserId', 'Firstname', 'Lastname', 'Email', 'Id', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('userId', 'firstname', 'lastname', 'email', 'id', ),
		BasePeer::TYPE_COLNAME => array (self::USER_ID, self::FIRSTNAME, self::LASTNAME, self::EMAIL, self::ID, ),
		BasePeer::TYPE_FIELDNAME => array ('user_id', 'firstname', 'lastname', 'email', 'id', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('UserId' => 0, 'Firstname' => 1, 'Lastname' => 2, 'Email' => 3, 'Id' => 4, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('userId' => 0, 'firstname' => 1, 'lastname' => 2, 'email' => 3, 'id' => 4, ),
		BasePeer::TYPE_COLNAME => array (self::USER_ID => 0, self::FIRSTNAME => 1, self::LASTNAME => 2, self::EMAIL => 3, self::ID => 4, ),
		BasePeer::TYPE_FIELDNAME => array ('user_id' => 0, 'firstname' => 1, 'lastname' => 2, 'email' => 3, 'id' => 4, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, )
	);
