...
$logger = new sfFileLogger($this->dispatcher, array_merge(array('auto_shutdown' => false), array (
  'level' => 'debug',
  'file' => '/Applications/MAMP/htdocs/eventus/proyecto/log/api_dev.log',
)));
$this->factories['logger']->addLogger($logger);
  ...
  'cache_dir' => '/Applications/MAMP/htdocs/eventus/proyecto/cache/api/dev/i18n',
  'lifetime' => 31556926,
  'prefix' => '/Applications/MAMP/htdocs/eventus/proyecto/apps/api/i18n',
));
...
'auto_shutdown' => false, 'session_id' => $this->getRequest()->getParameter('symfony'),
  ...
  'automatic_cleaning_factor' => 0,
  'cache_dir' => '/Applications/MAMP/htdocs/eventus/proyecto/cache/api/dev/template',
  'lifetime' => 86400,
  'prefix' => '/Applications/MAMP/htdocs/eventus/proyecto/apps/api/template',
)));
