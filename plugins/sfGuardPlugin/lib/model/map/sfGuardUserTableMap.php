...
class sfGuardUserTableMap extends TableMap {
    ...
    $this->addRelation('Token', 'Token', RelationMap::ONE_TO_MANY, array('id' => 'user_id', ), 'CASCADE', null);
    $this->addRelation('Event', 'Event', RelationMap::ONE_TO_MANY, array('id' => 'admin_id', ), 'CASCADE', null);
    $this->addRelation('Participation', 'Participation', RelationMap::ONE_TO_MANY, array('id' => 'user_id', ), 'CASCADE', null);
    $this->addRelation('Photo', 'Photo', RelationMap::ONE_TO_MANY, array('id' => 'user_id', ), 'CASCADE', null);
