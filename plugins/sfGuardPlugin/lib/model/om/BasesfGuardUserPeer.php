...
abstract class BasesfGuardUserPeer {
	...
	public static function clearRelatedInstancePool()
	{
		...
		// invalidate objects in TokenPeer instance pool, since one or more of them may be deleted by ON DELETE CASCADE rule.
	...
	protected static function doOnDeleteCascade(Criteria $criteria, PropelPDO $con)
	{
		...
		foreach ($objects as $obj) {
			...
			$criteria->add(EventPeer::ADMIN_ID, $obj->getId());
			...
			$criteria->add(ParticipationPeer::USER_ID, $obj->getId());
			...
			$criteria->add(PhotoPeer::USER_ID, $obj->getId());
