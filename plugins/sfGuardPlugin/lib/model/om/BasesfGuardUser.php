...
abstract class BasesfGuardUser extends BaseObject  implements Persistent {
	 ...
	 * If this collection has already been initialized with an identical Criteria, it returns the collection.
	 * Otherwise if this sfGuardUser has previously been saved, it will retrieve
	 * related Tokens from storage. If this sfGuardUser is new, it will return
	 * an empty collection or the current collection, the criteria is ignored on a new object.
	 *
	 * @param      PropelPDO $con
	 * @param      Criteria $criteria
		...
		if ($this->collTokens === null) {
			if ($this->isNew()) {
			   $this->collTokens = array();
				...
				$criteria->add(TokenPeer::USER_ID, $this->id);
		...
		if ($this->collEvents === null) {
			if ($this->isNew()) {
			   $this->collEvents = array();
				...
				$criteria->add(EventPeer::ADMIN_ID, $this->id);
	 ...
	 * If this collection has already been initialized with an identical Criteria, it returns the collection.
	 * Otherwise if this sfGuardUser has previously been saved, it will retrieve
	 * related Participations from storage. If this sfGuardUser is new, it will return
	 * an empty collection or the current collection, the criteria is ignored on a new object.
	 *
	 * @param      PropelPDO $con
	 * @param      Criteria $criteria
		...
		if ($this->collParticipations === null) {
			if ($this->isNew()) {
			   $this->collParticipations = array();
				...
				$criteria->add(ParticipationPeer::USER_ID, $this->id);
	 ...
	 * actually need in sfGuardUser.
	 */
	public function getParticipationsJoinEvent($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		if ($criteria === null) {
			$criteria = new Criteria(sfGuardUserPeer::DATABASE_NAME);
		}
		...
		if ($this->collParticipations === null) {
			if ($this->isNew()) {
				...
				$this->collParticipations = ParticipationPeer::doSelectJoinEvent($criteria, $con, $join_behavior);
			}
		} else {
			// the following code is to determine if a new query is
			// called for.  If the criteria is the same as the last
	 ...
	 * If this collection has already been initialized with an identical Criteria, it returns the collection.
	 * Otherwise if this sfGuardUser has previously been saved, it will retrieve
	 * related Photos from storage. If this sfGuardUser is new, it will return
	 * an empty collection or the current collection, the criteria is ignored on a new object.
	 *
	 * @param      PropelPDO $con
	 * @param      Criteria $criteria
		...
		if ($this->collPhotos === null) {
			if ($this->isNew()) {
			   $this->collPhotos = array();
				...
				$criteria->add(PhotoPeer::USER_ID, $this->id);
	 ...
	 * actually need in sfGuardUser.
	 */
	public function getPhotosJoinEvent($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		if ($criteria === null) {
			$criteria = new Criteria(sfGuardUserPeer::DATABASE_NAME);
		}
		...
		if ($this->collPhotos === null) {
			if ($this->isNew()) {
				...
				$this->collPhotos = PhotoPeer::doSelectJoinEvent($criteria, $con, $join_behavior);
			}
		} else {
			// the following code is to determine if a new query is
			// called for.  If the criteria is the same as the last
